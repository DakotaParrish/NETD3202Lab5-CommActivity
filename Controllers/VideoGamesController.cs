...
using NETD3202Lab5_CommActivity.Data;
using NETD3202Lab5_CommActivity.Models;

namespace NETD3202Lab5_CommActivity.Controllers
{
    public class VideoGamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("videoGameID,videoGameName,videoGameRating,videoGameGenre,videoGameRelease,videoGamePlatform")] VideoGame videoGame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("videoGameID,videoGameName,videoGameRating,videoGameGenre,videoGameRelease,videoGamePlatform")] VideoGame videoGame)
        {
